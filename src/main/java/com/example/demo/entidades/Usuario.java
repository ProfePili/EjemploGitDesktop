...
//    private String contraseña; // necesitamos una contraseña
    ...
    public Usuario(String email, String nombre, String apellido, Date fechaNacimiento, Boolean estaActivo, Direccion direccion, Rol rol) {
        this.email = email;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Usuario{" + "id=" + id + ", email=" + email + ", nombre=" + nombre + ", apellido=" + apellido + ", fechaNacimiento=" + fechaNacimiento + ", estaActivo=" + estaActivo + ", edad=" + edad + ", direccion=" + direccion + ", rol=" + rol + '}';
    }
